...
/**
 * Determines the inspection protocol category based on device data according to Kategóriák.pdf.
 * Returns one of:
 * - "Anyagmozgató Szerkezet"
 * - "Emelőszerkezet"
 * - "Teherfelvevő Eszköz" (default / fallback)
 * 
 * @param {object} deviceData The device or draft object.
...
export async function generateAndUploadFinalizedHtml(templateHtml, draft) {
    ...
    const categoryName = getDeviceCategory({ ...device, ...draft });
